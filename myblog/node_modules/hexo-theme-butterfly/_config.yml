...
footer:
  owner:
    enable: true
    since: 2024
  custom_text:  Hi, 欢迎观看我的博客 <a href="https://blog.csdn.net/weixin_49254673">点击这里进入</a>!"
...
aside:
  ...
  card_author:
    ...
    button:
      ...
      icon: fab fa-github
      text: '地址'
      link: https://github.com/likaiyuan00
  card_announcement:
    enable: true
    content: 心平能愈三千疾 心静可通万事理
  card_recent_post:
    enable: true
...
CDN:
  ...
  option:
    ...
    # translate:
    # twikoo:
     typed: https://cdn.jsdelivr.net/npm/typed.js/dist/typed.umd.min.js
    # utils:
    # valine:
    # waline_css:
    # waline_js:
